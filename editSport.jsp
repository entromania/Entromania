												...
												<div class="tab-content">
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal"
															action="<%=request.getContextPath()%>/sportCo"
															method="post">
															<c:forEach items="${sessionScope.editsport}" var="e">
															<div class="form-group mb-n">
															<input type="hidden" name="sportId" value="${e.sportId}">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Sport
																	Name</label>
																<div class="col-sm-8">
																	<input type="text" name="sportName" value="${e.sportName}"
																		class="form-control input-lg" id="largeinput"
																		placeholder="Enter Title for Concert" required>
																</div>
															</div>
															<br />
															<div class="form-group">
																<label for="col-sm-2 mb-n"
																	...
																	Desription</label>
																<div class="col-sm-8">
																	<textarea name="sportDescription" class="form-control autosize"
																		required>${e.sportDescription}</textarea>
																</div>
															</div>
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn" name="flag"
																		value="updatesport">Add Sport</button>

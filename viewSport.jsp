...
<li class="active"><a href="<%=request.getContextPath()%>/stadiumCo?flag=viewstadium">View Sport</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewsport}" var="s">
							<tr class="odd gradeX">
								<td>${s.sportId}</td>
								<td>${s.sportName}</td>
								<td>${s.sportDescription}</td>
								<td>
								<a href="<%=request.getContextPath()%>/sportCo?id=${s.sportId}&flag=deletesport"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/sportCo?id=${s.sportId}&flag=editsport"><button class="btn-primary btn">Edit</button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>

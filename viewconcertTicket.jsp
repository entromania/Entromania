...
<li class="active"><a href="<%=request.getContextPath()%>/conticketCo?flag=viewticket">View Ticket</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewcticket}" var="t">
							<tr class="odd gradeX">
								<td>${t.c_ticketId}</td>
								<td>${t.ticketname}</td>
								<td>${t.ticketprice}</td>
								<td>${t.ticketdesc}</td>
								<td class="center">${t.stadiumvo.stadium}</td>
								<td class="center">${t.concertvo.title}</td>
								<td>
								<a href="<%=request.getContextPath()%>/conticketCo?id=${t.c_ticketId}&flag=deleteticket"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/conticketCo?id=${t.c_ticketId}&flag=editticket"><button class="btn-primary btn">Edit</button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>

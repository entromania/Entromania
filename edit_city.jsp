...
<li class="active"><a href="edit_city.jsp">Edit City</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/cityCo" method="get">
							<c:forEach var="i" items="${sessionScope.view_city}">
							<div class="form-group mb-n">
									...
									<select name="loadstate" id="selector1" class="form-control">
										...
										<c:if test="${i.statevo.id eq b.id }"><option selected="selected" value="${b.id}">${b.state}</option></c:if>
										<c:if test="${i.statevo.id ne b.id }"><option value="${b.id}">${b.state}</option></c:if>
										</c:forEach>
									</select>
									</div>
								</div> <br>
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">City Name</label>
									<div class="col-sm-8">
										<input type="text" name="city" class="form-control input-lg" value="${i.city}" id="largeinput" placeholder="Enter City Name">
										<input type="hidden" name="id" value="${i.c_id}">
									</div>
								 </div> <br/>
								  
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Pincode</label>
									<div class="col-sm-8">
										<input type="text" name="pincode" class="form-control input-lg" value="${i.pincode}" id="largeinput" placeholder="Enter Pincode" required>
									</div>
								 </div> 
								<br/>
								</c:forEach>
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn">Update City</button>

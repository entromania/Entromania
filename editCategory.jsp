												...
												<div class="tab-content">
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal"
															action="<%=request.getContextPath()%>/CategoryCo"
															method="post">
															<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
															<c:forEach items="${sessionScope.editCategory}" var="v">
															<div class="form-group mb-n">
															<input type="hidden" name="categoryId" value="${v.categoryId}" >
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Category
																	Name</label>
																<div class="col-sm-8">
																	<input type="text" name="categoryName" value="${v.categoryName}"
															...
															<div class="form-group">
																<label for="col-sm-2 mb-n"
																	...
																	Desription</label>
																<div class="col-sm-8">
																	<textarea name="categoryDescription" class="form-control autosize"
																		required>${v.categoryDescription}</textarea>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn" name="flag"
																		value="updateCategory">Update Category</button>

				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form name="stadiumForm" class="form-horizontal" action="<%=request.getContextPath()%>/ticketCo" method="post">
							<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
							<c:forEach var="v" items="${sessionScope.editticket}">
							<div class="form-group mb-n">
									<input type="hidden" value="${v.ticketId}" name="ticketId">
									...
									<c:if test="${v.stadiumvo.s_id eq s.s_id }"><option selected="selected" value="${s.s_id}">${s.stadium}</option></c:if>
										<c:if test="${v.stadiumvo.s_id ne s.s_id }"><option value="${s.s_id}">${s.stadium}</option></c:if>
									</c:forEach>
									</select>
									</div>
							</div> <br>
							<div class="form-group mb-n">
								    <label for="largeinput" class="col-sm-2 control-label label-input-lg">Select Match</label>
									<div class="col-sm-8">
									<select name="matchid" id="matchid" class="form-control">
									<c:forEach items="${sessionScope.loadmatch}" var="m">
									<c:if test="${v.matchvo.m_id eq m.m_id }"><option selected="selected" value="${m.m_id}">${m.title}</option></c:if>
										<c:if test="${v.matchvo.m_id ne m.m_id }"><option value="${m.m_id}">${m.title}</option></c:if>
									</c:forEach>
									</select>
									</div>
							</div> <br>
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="text" name="ticketname" class="form-control input-lg" value="${v.ticketname}" id="largeinput" placeholder="Enter Ticket Name" required>
									</div>
								 </div> <br>
								 <div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Ticket Price</label>
									<div class="col-sm-8">
										<input type="text" name="ticketprice" class="form-control input-lg" id="largeinput" value="${v.ticketprice}" placeholder="Enter Ticket Price" required>
									</div>
								 </div> 
								<br/>
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<textarea name="ticketdesc"  value="${v.ticketdesc}" class="form-control autosize" required></textarea>
									</div>
								 </div> <br/>

...
<head>
    ...
    <meta charset="utf-8">
    <title>Add Concert Ticket</title>
...
<li class="active"><a href="concertTicket.jsp">Add Concert Ticket</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							...
							<div class="form-group mb-n">
									...
									<option value="${s.s_id}">${s.stadium}</option>
									</c:forEach>
									</select>
									</div>
							</div> <br>
							<div class="form-group mb-n">
									...
									<option value="${m.cn_id}">${m.title}</option>
									</c:forEach>
									</select>
									</div>
							</div> <br>
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="text" name="ticketname" class="form-control input-lg" id="largeinput" placeholder="Enter Ticket Name" required>
									</div>
								 </div> <br>
								 <div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Ticket Price</label>
									<div class="col-sm-8">
										<input type="text" name="ticketprice" class="form-control input-lg" id="largeinput" placeholder="Enter Ticket Price" required>
									</div>
								 </div> 
								<br/>
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">No Of Tickets</label>
									<div class="col-sm-8">
										<input type="text" name="noOfTickets" class="form-control input-lg" id="largeinput" placeholder="Enter No Of Tickets" required>
									</div>
								 </div><br>
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Description</label>
									<div class="col-sm-8">
										<textarea name="ticketdesc"  class="form-control autosize" required></textarea>
									</div>
								 </div> <br/>
								
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="flag" value="addticket">Add Ticket</button>

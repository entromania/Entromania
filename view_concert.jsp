...
<li class="active"><a href="<%=request.getContextPath()%>/concertCo?flag=viewconcert">View Concert</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewconcert}" var="w">
							<tr class="odd gradeX">
								<td>${w.cn_id}</td>
								<td>${w.title}</td>
								<td>${w.stadiumvo.stadium}</td>
								<td>${w.date}</td>
								<td>${w.time}</td>
								<td>${w.c_des}</td>
								<td>
								<a href="<%=request.getContextPath()%>/concertCo?id=${w.cn_id}&flag=deleteconcert"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/concertCo?id=${w.cn_id}&flag=editconcert"><button class="btn-primary btn">Edit</button></a>
								</td>
							   </tr>
						</c:forEach>
						</tbody>

											...
											<div class="panel-body">
												<div class="tab-content">
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal" action="<%=request.getContextPath()%>/complainCo" method="post">
														<c:forEach items="${sessionScope.replyList}"  var="v">
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Title</label>
																<div class="col-sm-8">
																	<input type="hidden" name="replyTo" value="${v.loginVoFrom.loginId }">
																	<input type="text" name="title" value="${v.complainTitle}"class="form-control input-lg"
															...
															<div class="form-group">
																<label for="col-sm-2 mb-n"
																	class="col-sm-2 control-label label-input-lg">Complain
																	Description</label>
																<div class="col-sm-8">
																	<textarea name="complainDescription"  class="form-control autosize" required>${v.complainDescription }</textarea>
																</div>
															</div>
															...
															<div class="form-group">
																<label for="col-sm-2 mb-n"
																	...
																	Reply</label>
																<div class="col-sm-8">
																	<textarea name="complainReply"  class="form-control autosize" required></textarea>
																</div>
															</div>
															
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn" name="flag" value="replytouser">Reply</button>

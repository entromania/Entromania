...
<li class="active"><a href="view_sponsership.jsp">View Sponsership</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewSponser}" var="p">
							<tr class="odd gradeX">
								<td>${p.sponserId}</td>
								<td>${p.sponserName}</td>
								<td><img height="100px" width="100px" src="${pageContext.request.contextPath }/doc/${p.attachmentVo.encryptedFileName}"></td>
								<td>
								   <a href="<%=request.getContextPath()%>/SponserCo?id=${p.sponserId}&flag=deleteSponser"><button class="btn-primary btn">Delete</button></a> | 
								   <a href="<%=request.getContextPath()%>/SponserCo?id=${p.sponserId}&flag=editSponser"><button class="btn-primary btn">Edit</button></a>
								</td>
							 </tr>
						</c:forEach>
						</tbody>

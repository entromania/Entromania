												...
												<div class="tab-content">
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal"
															action="<%=request.getContextPath()%>/SubCategoryCo"
															method="post">
															<%@taglib uri="http://java.sun.com/jstl/core_rt"
																prefix="c"%>
															<c:forEach items="${sessionScope.editSubCategory}" var="a">
															<div class="form-group mb-n">
															<input type="hidden" value="${a.subcategoryId}" name="subcategoryId">
																...
																<div class="col-sm-8">
																	<select name="categoryId" id="selector1" class="form-control">
																		<c:forEach items="${sessionScope.loadCategory}"
																			var="s">
																			<c:if test="${a.categoryVo.categoryId eq s.categoryId}"><option selected="selected" value="${s.categoryId}">${s.categoryName}</option></c:if>
																			<c:if test="${a.categoryVo.categoryId ne s.categoryId}"><option value="${s.categoryId}">${s.categoryName}</option></c:if> 
																		</c:forEach>
																	</select>
																</div>
															</div>
															...
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">SubCategory
																	Name</label>
																<div class="col-sm-8">
																	<input type="text" name="subcategoryName" value="${a.subcategoryName}"
															...
															<div class="form-group">
																<label for="col-sm-2 mb-n"
																	...
																	Desription</label>
																<div class="col-sm-8">
																	<textarea name="subcategoryDescription" class="form-control autosize"
																		required>${a.subcategoryDescription}</textarea>
																</div>
															</div>
															<br />
															</c:forEach>
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn">Add SubCategory</button>

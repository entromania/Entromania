...
<li class="active">Edit Stadium</li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/stadiumCo" method="get">
							<c:forEach items="${sessionScope.editstadium}" var="s">
							<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										...
										<input type="text" name="stadium" value="${s.stadium}" class="form-control input-lg" id="largeinput" placeholder="Enter Stadium Name">
									</div>
								 </div> <br/>
							<div class="form-group mb-n">
									...
									<select name="loadstate" id="selector1" class="form-control">
										...
										<c:if test="${s.statevo.id eq b.id }"><option selected="selected" value="${b.id}">${b.state}</option></c:if>
										<c:if test="${s.statevo.id ne b.id }"><option value="${b.id}">${b.state}</option></c:if>
										</c:forEach>
									</select>
									</div>
								</div> <br>
								<div class="form-group mb-n">
									...
									<select name="loadcity" id="selector1" class="form-control">
										...
										<c:if test="${s.cityvo.c_id eq q.c_id }"><option selected="selected" value="${q.c_id}">${q.city}</option></c:if>
										<c:if test="${s.cityvo.c_id ne q.c_id }"><option value="${q.c_id}">${q.city}</option></c:if>
										</c:forEach>
									</select>
									</div>
								</div> <br>					  
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="text" name="capacity" value="${s.capacity}" class="form-control input-lg" id="largeinput" placeholder="Enter Capacity Of People" required>
									</div>
								 </div> <br>
								 <div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Parking Capacity</label>
									<div class="col-sm-8">
										<input type="text" name="p_capacity" value="${s.p_capacity}" class="form-control input-lg" id="largeinput" placeholder="Enter Capacity Of Parking" required>
									</div>
								 </div> 
								<br/>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="flag" value="updatestadium">Update Stadium</button>

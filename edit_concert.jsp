				...
				<div class="static-content">
					<div class="page-content">
						<ol class="breadcrumb">
							...
							<li class="active">Edit Concert</li>
									...
									<div class="col-sm-12">
											...
											<div class="panel-body">
												<div class="tab-content">
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal" action="<%=request.getContextPath()%>/concertCo" method="get">
														<c:forEach items="${sessionScope.editconcert}"  var="v">
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Title</label>
																<div class="col-sm-8">
																	<input type="hidden" name="cn_id" value="${v.cn_id }">
																	<input type="text" name="title" value="${v.title}"class="form-control input-lg"
															...
															<div class="form-group mb-n">
																<label for="largeinput"
																	...
																	Stadium</label>
																<div class="col-sm-8">
																	<select name="loadstadium" id="selector1"
																		class="form-control">
										...
										<c:if test="${v.stadiumvo.s_id ne w.s_id }"><option value="${w.s_id}">${w.stadium}</option></c:if>
															...
															<div class="form-group mb-n">
																...
																<div class="col-sm-6">
																	<input type="date" name="date" value="${v.date }"class="form-control input-lg"
															...
															<div class="form-group mb-n">
																...
																<div class="col-sm-8">
																	<input type="text" name="time" value="${v.time }" class="form-control input-lg"
															...
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn" name="flag" value="updateconcert">Add Concert</button>

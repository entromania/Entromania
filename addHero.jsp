				...
				<div class="static-content">
					<div class="page-content">
						<ol class="breadcrumb">
							...
							<li class="active"><a href="addHero.jsp">Add Hero</a></li>
													...
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal"
															...
															<div class="form-group mb-n">
																...
																<div class="col-sm-8">
																	<input type="date" name="heroDob" class="form-control input-lg" data-inputmask="'alias':'date'" required>
																</div>
															</div><br>
															<div class="form-group mb-n">
																<label for="largeinput"
																...
																<div class="col-sm-8">
																	<input type="text" name="heroPosition"
																		class="form-control input-lg" id="largeinput"
										...
										<input type="file" name="heroImage">
															...
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn">Add Hero</button>
																	<input type="hidden" name="flag" value="addHero">
																</div>
															</div>

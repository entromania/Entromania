...
<li class="active"><a href="search-state.jsp">Search State</a></li>
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tr class="odd gradeX">
							...
							<td>${i.state}</td>
							<td>
								<a href="<%=request.getContextPath()%>/insertState?id=${i.id}&flag=deleteState"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/insertState?id=${i.id}&flag=editState"><button class="btn-primary btn">Edit</button></a>
							</td>
						</tr>
						</c:forEach>
						</tbody>

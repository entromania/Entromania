...
<li class="active"><a href="<%=request.getContextPath()%>/stadiumCo?flag=viewstadium">View Stadium</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewstadium}" var="s">
							<tr class="odd gradeX">
								<td>${s.s_id}</td>
								<td>${s.stadium}</td>
								<td>${s.cityvo.city}</td>
								<td>${s.statevo.state}</td>
								<td class="center">${s.capacity}</td>
								<td class="center">${s.p_capacity}</td>
								<td>
								<a href="<%=request.getContextPath()%>/stadiumCo?id=${s.s_id}&flag=deletestadium"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/stadiumCo?id=${s.s_id}&flag=editstadium"><button class="btn-primary btn">Edit</button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>

...
<li class="active"><a href="view-city.jsp">View City</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.view_city}" var="i"> 
						<tr class="odd gradeX">
							<td>${i.c_id}</td>
							<td>${i.city}</td>
							<td>${i.pincode}</td>
							<td>${i.statevo.state }</td>
							<td>
								<a href="<%=request.getContextPath()%>/cityCo?id=${i.c_id}&flag=deletecity"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/cityCo?id=${i.c_id}&flag=editcity"><button class="btn-primary btn">Edit</button></a>
							</td>
						</tr>
						</c:forEach>
						</tbody>

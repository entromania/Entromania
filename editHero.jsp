		...
		<div id="layout-static">
			...
			<div class="static-content-wrapper">
				<div class="static-content">
												...
												<div class="tab-content">
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal"
															action="<%=request.getContextPath()%>/HeroesCo"
															method="post" enctype="multipart/form-data">															
															<div class="form-group mb-n">
															<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
															<c:forEach items="${sessionScope.editHero}" var="h" >
															<input type="hidden" name="heroId" value="${h.heroId}">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Hero's
																	Name</label>
																<div class="col-sm-8">
																	<input type="text" name="heroName" value="${h.heroName }"
																		class="form-control input-lg" id="largeinput"
																		placeholder="Enter Hero's Name" required>
																</div>
															</div>
															<br />
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Hero's Age</label>
																<div class="col-sm-8">
																	<input type="text" name="heroAge" value="${h.heroAge}"
																		class="form-control input-lg" id="largeinput"
																		placeholder="Enter Hero's Age" required>
																</div>
															</div><br>
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Hero's D.O.B.
																</label>
																<div class="col-sm-8">
																	<input type="date" name="heroDob" class="form-control input-lg" value="${h.heroDob}" data-inputmask="'alias':'date'" required>
																</div>
															</div><br>
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Hero's Position</label>
																<div class="col-sm-8">
																	<input type="text" name="heroPosition" value="${h.heroPosition}"
																		class="form-control input-lg" id="largeinput"
																		placeholder="Enter Hero's Position" required>
																</div>
															</div><br>
					...
					<div class="col-sm-8">
					<img height="100px" width="100px" src="${pageContext.request.contextPath }/doc/${h.attachmentVo.encryptedFileName}">
															</c:forEach><br/>
										...
										<input type="file" name="heroImage">
															...
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn">Update Hero</button>
																	<input type="hidden" name="flag" value="updateHero">
																</div>
															</div>

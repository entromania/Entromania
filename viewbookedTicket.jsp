...
<li class="active">View Booked Ticket</li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewbookedticket}" var="t">
							<tr class="odd gradeX">
								<td>${t.bookingId}</td>
								<td>${t.name}</td>
								<td>${t.phone}</td>
								...
								<td>
								<a href="<%=request.getContextPath()%>/bookticketCo?id=${t.bookingId}&flag=deleteticket"><button class="btn-primary btn">Delete</button></a> | 
								</td>
							</tr>
						</c:forEach>
						</tbody>

...
<li class="active"><a href="add-state.jsp">Add State</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/insertState" method="get">
							<c:forEach var="i" items="${sessionScope.search_state}">
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">State Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control input-lg" id="largeinput" placeholder="Enter State Name"  value="${i.state}" name="state" required>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="flag" value="updateState">Update State</button>

...
<li class="active">Edit Sponsership</li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							...
							<c:forEach items="${sessionScope.editSponser}" var="p">
									
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Title</label>
									<div class="col-sm-8">
										<input type="hidden" name="sponserId" value="${p.sponserId}">
										<input type="text" class="form-control input-lg" value="${p.sponserName}" name="sponserName" id="largeinput" placeholder="Enter Title" required>
									</div>
								</div> <br/>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="flag" value="updateSponser">Update Sponser</button>

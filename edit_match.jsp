				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							...
							<c:forEach items="${sessionScope.editmatch}" var="m">
							<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										...
										<input type="text" value="${m.title}" class="form-control input-lg" name="title" id="largeinput" placeholder="Enter Title for Match" required>
									</div>
								 </div> <br/>
								 <div class="form-group mb-n">
									...
									<select name="loadstadium" id="selector1" class="form-control">
										...
										<c:if test="${m.stadiumvo.s_id eq w.s_id }"><option selected="selected" value="${w.s_id}">${w.stadium}</option></c:if>
										<c:if test="${m.stadiumvo.s_id ne w.s_id }"><option value="${w.s_id}">${w.stadium}</option></c:if>
										</c:forEach>
									</select>
									</div>
								</div> <br>
								  <div class="form-group mb-n">
                            		...
                            		<div class="col-sm-6">
                                		<input type="date" name="date" value="${m.date}" class="form-control input-lg" data-inputmask="'alias':'date'" required>
                            		</div>
                       			 </div> <br>
                        ...
                        <div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="text" name="time" value="${m.time}" class="form-control input-lg" id="largeinput" placeholder="Enter Timing Of Match" required>
									</div>
								 </div> <br/>
								 <div class="form-group">
					<label for="col-sm-2 mb-n" class="col-sm-2 control-label label-input-lg">Match Desription</label>
					<div class="col-sm-8">
						<textarea name="m_des" value="${m.m_des}" class="form-control autosize" required></textarea>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="flag" value="updatematch" >Update Match</button>

...
<li class="active"><a href="<%=request.getContextPath()%>/CategoryCo?flag=viewCategory">View Category</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewCategory}" var="s">
							<tr class="odd gradeX">
								<td>${s.categoryId}</td>
								<td>${s.categoryName}</td>
								<td>${s.categoryDescription}</td>
								<td>
								<a href="<%=request.getContextPath()%>/CategoryCo?id=${s.categoryId}&flag=deleteCategory"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/CategoryCo?id=${s.categoryId}&flag=editCategory"><button class="btn-primary btn">Edit</button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>

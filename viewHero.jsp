...
<li class="active"><a href="<%=request.getContextPath()%>/HeroesCo?flag=viewHero">View Heroes</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewHero}" var="s">
							<tr class="odd gradeX">
								<td>${s.heroId}</td>
								<td>${s.heroName}</td>
								<td>${s.heroPosition}</td>
								<td>${s.heroDob}</td>
								<td>${s.heroAge}</td>
								<td><img height="100px" width="100px" src="${pageContext.request.contextPath }/doc/${s.attachmentVo.encryptedFileName}"></td>
								<td>
								<a href="<%=request.getContextPath()%>/HeroesCo?id=${s.heroId}&flag=deleteHero"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/HeroesCo?id=${s.heroId}&flag=editHero"><button class="btn-primary btn">Edit</button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>

...
<li class="active"><a href="<%=request.getContextPath()%>/SubCategoryCo?flag=viewSubCategory">View SubCategory</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewSubcategory}" var="s">
							<tr class="odd gradeX">
								...
								<td>
								<a href="<%=request.getContextPath()%>/SubCategoryCo?id=${s.subcategoryId}&flag=deleteSubCategory"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/SubCategoryCo?id=${s.subcategoryId}&flag=editSubCategory"><button class="btn-primary btn">Edit</button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>

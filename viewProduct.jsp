...
<li class="active"><a href="<%=request.getContextPath()%>/ProductCo?flag=viewProduct">View Product</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<c:forEach items="${sessionScope.viewProduct}" var="s">
							<tr class="odd gradeX">
								<td>${s.productId}</td>
								<td>${s.productName}</td>
								<td>${s.productPrice}</td>
								<td>${s.categoryVo.categoryName}</td>
								<td>${s.subcategoryVo.subcategoryName}</td>
								<td>${s.productDescription}</td>
								<td><img height="100px" width="100px" src="${pageContext.request.contextPath }/doc/${s.attachmentVo.encryptedFileName}"></td>
								<td>
								<a href="<%=request.getContextPath()%>/ProductCo?id=${s.productId}&flag=deleteProduct"><button class="btn-primary btn">Delete</button></a> | 
								<a href="<%=request.getContextPath()%>/ProductCo?id=${s.productId}&flag=editProduct"><button class="btn-primary btn">Edit</button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>
